...
public class MapsActivitydsddsdsd extends FragmentActivity implements OnMapReadyCallback, LocationListener {
//host
...
//       textView.setText(String.valueOf(randomNumber));
       ...
       String userKaId=auth.getUid();
        ...
        String userFeromshare=sharedPreferences.getString("userName","nahi chala");
                ...
                mapFragment.getMapAsync( MapsActivitydsddsdsd.this);
                ActivityCompat.requestPermissions(MapsActivitydsddsdsd.this, new String[]{
