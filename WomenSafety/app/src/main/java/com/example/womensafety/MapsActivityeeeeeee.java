...
//
//public class MapsActivityeeeeeee extends FragmentActivity implements OnMapReadyCallback,
...
//                Toast.makeText(MapsActivityeeeeeee.this, "Showing Nearby Hospitals", Toast.LENGTH_SHORT).show();
//                break;
//
//
//            case R.id.B_schools:
...
//
//                getNearbyPlacesData.execute(dataTransfer);
//                Toast.makeText(MapsActivityeeeeeee.this, "Showing Nearby Schools", Toast.LENGTH_SHORT).show();
//                break;
...
//
//                getNearbyPlacesData.execute(dataTransfer);
//                Toast.makeText(MapsActivityeeeeeee.this, "Showing Nearby Restaurants", Toast.LENGTH_SHORT).show();
//                break;
//            case R.id.B_to:
//        }
//    }
...
//                    manager.requestLocationUpdates(LocationManager.GPS_PROVIDER, MIN_TIME, MIN_DISTANCE, (android.location.LocationListener) this);
//
